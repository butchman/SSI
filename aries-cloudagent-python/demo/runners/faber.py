...
async def main(
    ...
    try:
        ...
        #await agent.register_did('http://dev.bcovrin.vonx.io',wallet_seed,wallet_did,wallet_verkey)
        ...
        print('public DID is:', await agent.get_public_did())
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        type=str,
        metavar="<seed>",
        help="Set the agent seed",
    )
    parser.add_argument(
        "--wallet-did",
        type=str,
        metavar="<wallet-did>",
        help="Set the wallet did",
    )
    parser.add_argument(
        "--wallet-verkey",
        type=str,
        metavar="<wallet-verkey>",
        help="Set the wallet verkey",
    )
