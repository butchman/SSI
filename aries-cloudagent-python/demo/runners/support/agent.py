...
class DemoAgent:
    ...
    async def register_schema_and_creddef(
        ...
        print('/credential-definitions request')
        print(credential_definition_body)
        print('-----------------------------------------------------------------')
        credential_definition_response = await self.admin_POST(
            "/credential-definitions", credential_definition_body
        )
        print('credential_definition_response')
        print(credential_definition_response)
        print('-----------------------------------------------------------------')
        ...
        schema_response = await self.admin_GET("/schemas/created?did=" + self.did)
        print('schema_response')
        print(schema_response)
        print('-----------------------------------------------------------------')
