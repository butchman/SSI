...
const getMLGInvite = async () => {
  try {
    return await clientMlg.createConnection({});
  } catch (e) {
    console.log(e.message || e.toString());
  }
}
